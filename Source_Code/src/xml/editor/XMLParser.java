...
;
    ...
    public static void main(String[] args) {
        ...
        try {
          ...
          System.out.println("--------Please Enter Parameter for example: PlayerA.xml,PlayerB.xml,Composition.xml -------- ");  
...
{        List<String> list = Arrays.asList(str.split(","));
            ...
            for (int i = 0; i < (list.size()-1); i++) {
                ...
                saxParser.parse(new File(list.get(i)), handler);
            ...
            saxParserComposition.parse(new File(list.get(list.size()-1)), handlerComposition);
